...
<div class="mt-4">
    <div class="container">
        <div class="card" style="padding: 15px;">
            <h4>Data Laundry</h4>
            <form action="/transaction" data-parsley-validate novalidate method="post">
                @csrf
                <div class="row mb-3">
                    <label for="colFormLabel" class="col-sm-2 col-form-label">Nama</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="nama" name="nama" placeholder="example: Saipuddin">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="colFormLabel" class="col-sm-2 col-form-label">Pilih jenis laundry</label>
                    <div class="col-sm-10">
                        <select class="form-select" id="jenis" name="jenis" aria-label="Default select example" onChange="getTotalHarga()">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="berat" name="berat" placeholder="example: 5" onChange="getTotalHarga()">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="harga" name="harga" aria-label="Dollar amount (with dot and two decimal places)" value="" readonly>
                        </div>
                    </div>
                </div>
