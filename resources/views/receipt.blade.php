...
<div class="container">
    <div class="card" style="padding: 15px;">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="colFormLabel" placeholder="" disabled value="@isset($transaction->berat){{$transaction->berat}}@endisset">
            </div>
        </div>
        <div class="row mb-3">
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
            <button onclick="alert" class="btn btn-primary" type="button">Print</button>
        </div>
    </div>
</div>
</div>
